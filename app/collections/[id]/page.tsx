...
export default async function CollectionDetailPage({
  ...
  if (recipeIds.length > 0) {
    ...
    // Preserve collection order (added_at desc)
    const recipeMap = Object.fromEntries(
      (recipesData ?? []).map((r) => [r.id, r])
    );

    recipes = recipeIds
      .map((rid) => recipeMap[rid])
      .filter(Boolean)
      .map((r) => ({
        ...r,
        ...
        <div style={{ maxWidth: "80rem", margin: "0 auto", padding: "2rem" }}>
          ...
          <Link
            ...
            style={{
              ...
              fontSize: 14, fontWeight: 600, color: "#86C540",
          ...
          {recipes.length === 0 ? (
            <div style={{ textAlign: "center", padding: "5rem 1rem" }}>
              ...
              <p style={{ color: "#9ca3af", fontSize: "0.9375rem", margin: "0 0 1.5rem" }}>
